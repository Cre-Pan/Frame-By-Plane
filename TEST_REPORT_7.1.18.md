...
> Nota storica: gli hash della tabella pacchetti precedono l'ultima correzione Bookmark. Gli hash definitivi dei cinque ZIP sono documentati in `FOLLOWUP_AUDIT_7.1.18.md`.
