...
1. **Native platform runtime coverage.** Runtime tests were executed on Windows x64. Linux x64, macOS x64/ARM64 and Windows ARM64 packages passed structural validation only. This is the principal release risk.
...
- preferably run native smoke tests on every declared platform, especially macOS ARM64 and Linux x64;
