...
FBP_EFFECT_REGISTRY = {
    ...
    FBP_EFFECT_CUTOUT_OUTLINE: {
        ...
        "source_names": (), "canonical_name": "FBP_GN_Cutout_Outline_573",
        "modifier_name": "FBP • Cutout Outline", "asset_id": "frame_by_plane.cutout_outline.573",
    ...
    FBP_EFFECT_CAMERA_BILLBOARD: {
        ...
        "modifier_name": "FBP • Mirror", "asset_id": "frame_by_plane.camera_billboard.497",
    ...
    FBP_EFFECT_THICKNESS: {
        ...
        "source_names": ("FBP_Thickness",), "canonical_name": "FBP_GN_Extrude_585",
        "modifier_name": "FBP • Extrude", "asset_id": "frame_by_plane.extrude.585",
    ...
    FBP_EFFECT_PIXELATE: {
        ...
        "source_names": (), "canonical_name": "FBP_SH_Pixelate_462",
        "asset_id": "frame_by_plane.shader.pixelate.462", "enabled_key": "fbp_effect_pixelate",
        "input_socket": "Vector", "output_socket": "Vector Out",
        "property_map": {
    ...
    FBP_EFFECT_DEPTH_BLUR: {
        "label": "Manual / Depth Blur", "icon": "MOD_SMOOTH", "kind": "SHADER", "stage": "COLOR",
        ...
        "private_group": True, "image_aware": True, "camera_aware": True, "builtin": True,
        "supports": ("IMAGE", "SEQUENCE"),
    },
    ...
    FBP_EFFECT_LUMA_MATTE: {
        "label": "Luma Matte", "icon": "IMAGE_ZDEPTH", "kind": "SHADER", "stage": "MASK",
    ...
    FBP_EFFECT_CLIPPING_MASK: {
        "label": "Clipping Mask", "icon": "MOD_MASK", "kind": "SHADER", "stage": "MASK",
        "source_names": (), "canonical_name": "FBP_SH_Clipping_Mask_553",
        "asset_id": "frame_by_plane.shader.clipping_mask.553", "enabled_key": "fbp_effect_clipping_mask",
        "input_socket": "Alpha In", "output_socket": "Alpha Out", "mask_output_socket": "Mask Out", "uv_input_socket": "UV Vector",
        "debug_socket": "Debug Preview",
        "debug_modes": (("FINAL", "Final"), ("MATTE", "Matte"), ("SOURCE", "Source")),
        "property_map": {
    ...
    FBP_EFFECT_COLOR_MASK: {
        "label": "Color Mask", "icon": "COLOR", "kind": "SHADER", "stage": "MASK",
    ...
    FBP_EFFECT_GRADIENT_MASK: {
        "label": "Gradient Mask", "icon": "IPO_LINEAR", "kind": "SHADER", "stage": "MASK",
    ...
    FBP_EFFECT_NOISE_MASK: {
        "label": "Noise Mask", "icon": "RNDCURVE", "kind": "SHADER", "stage": "MASK",
    ...
    FBP_EFFECT_GRADIENT_LIGHT: {
        "label": "Gradient Light", "icon": "LIGHT", "kind": "SHADER", "stage": "COLOR",
        "source_names": ("FBP_2D_Gradient_Light",), "canonical_name": "FBP_SH_Gradient_Light_570",
        "asset_id": "frame_by_plane.shader.gradient_light.570", "enabled_key": "fbp_effect_gradient_light",
        "input_socket": "Color In", "output_socket": "Color Out", "uv_input_socket": "UV Vector",
        "private_group": True, "rig_private_group": True, "builtin": True,
        "required_input_sockets": ("Light Angle", "Light Position", "Strength"),
        "property_map": {
    ...
    FBP_EFFECT_RIM: {
        ...
        "source_names": (), "canonical_name": "FBP_SH_Rim_570",
        "asset_id": "frame_by_plane.shader.rim.570", "enabled_key": "fbp_effect_rim",
        "input_socket": "Color In", "output_socket": "Color Out", "uv_input_socket": "UV Vector",
        "alpha_input_socket": "Alpha In", "alpha_output_socket": "Alpha Out",
        "image_aware": True, "private_group": True, "builtin": True,
        "required_input_sockets": ("Use Image Sample", "Width", "Softness", "Intensity", "Rim Color"),
        "property_map": {
            "fbp_rim_width": "Width",
...
FBP_SHADER_STAGE_ORDER = {
    ...
    "MASK": (
        FBP_EFFECT_CLIPPING_MASK, FBP_EFFECT_ALPHA_MATTE, FBP_EFFECT_LUMA_MATTE,
        FBP_EFFECT_COLOR_MASK, FBP_EFFECT_GRADIENT_MASK, FBP_EFFECT_NOISE_MASK,
        FBP_EFFECT_SQUARE_MASK, FBP_EFFECT_CIRCLE_MASK, FBP_EFFECT_TRIANGLE_MASK,
    ),
    "COLOR": (
        FBP_EFFECT_DEPTH_BLUR, FBP_EFFECT_CHROMA_KEY, FBP_EFFECT_SOLID_MASK, FBP_EFFECT_HUE_SATURATION,
        ...
        FBP_EFFECT_DIGITAL_NOISE,
        FBP_EFFECT_PAPER_FIBERS, FBP_EFFECT_GRADIENT_LIGHT, FBP_EFFECT_RIM, FBP_EFFECT_GOBO_SHADOWS,
...
FBP_2D_EFFECT_MENU_ORDER = (
    FBP_EFFECT_UV_DISTORTION, FBP_EFFECT_PIXELATE, FBP_EFFECT_DEPTH_BLUR, FBP_EFFECT_GRAIN,
    FBP_EFFECT_DIGITAL_NOISE, FBP_EFFECT_HALFTONE, FBP_EFFECT_DOT_MATRIX,
    FBP_EFFECT_ASCII_MATRIX, FBP_EFFECT_ASCII, FBP_EFFECT_PAPER_FIBERS,
    FBP_EFFECT_GRADIENT_LIGHT, FBP_EFFECT_RIM, FBP_EFFECT_GOBO_SHADOWS, FBP_EFFECT_CRT_SCANLINES,
    FBP_EFFECT_VIGNETTE, FBP_EFFECT_POSTERIZE,
)
FBP_MASK_EFFECT_MENU_ORDER = (
    FBP_EFFECT_SQUARE_MASK, FBP_EFFECT_CIRCLE_MASK, FBP_EFFECT_TRIANGLE_MASK,
    FBP_EFFECT_COLOR_MASK, FBP_EFFECT_GRADIENT_MASK, FBP_EFFECT_NOISE_MASK,
    FBP_EFFECT_ALPHA_MATTE, FBP_EFFECT_LUMA_MATTE,
)
FBP_3D_EFFECT_MENU_ORDER = (
    ...
    FBP_EFFECT_MESH_RIPPLE, FBP_EFFECT_PAPER_CURL, FBP_EFFECT_CUTOUT_OUTLINE, FBP_EFFECT_THICKNESS, FBP_EFFECT_INFINITE_ROTATION, FBP_EFFECT_FELT_FUZZ,
    FBP_EFFECT_TEXT_MATRIX,
)
...
FBP_IMAGE_EFFECT_MENU_SECTIONS = (
    ...
    (
        ...
        (
            FBP_EFFECT_UV_DISTORTION, FBP_EFFECT_PIXELATE, FBP_EFFECT_DEPTH_BLUR, FBP_EFFECT_HALFTONE,
            FBP_EFFECT_DOT_MATRIX, FBP_EFFECT_ASCII_MATRIX, FBP_EFFECT_ASCII,
            FBP_EFFECT_GRADIENT_LIGHT, FBP_EFFECT_RIM, FBP_EFFECT_GOBO_SHADOWS,
            FBP_EFFECT_POSTERIZE,
        ),
    ),
    (
...
FBP_MASK_EFFECT_MENU_SECTIONS = (
    (
        "Shape Masks", "MOD_MASK",
        (FBP_EFFECT_SQUARE_MASK, FBP_EFFECT_CIRCLE_MASK, FBP_EFFECT_TRIANGLE_MASK),
    ),
    (
        "Generated Masks", "NODE_TEXTURE",
        (FBP_EFFECT_COLOR_MASK, FBP_EFFECT_GRADIENT_MASK, FBP_EFFECT_NOISE_MASK),
    ),
    (
        "Track Mattes", "IMAGE_ALPHA",
        (FBP_EFFECT_ALPHA_MATTE, FBP_EFFECT_LUMA_MATTE),
    ),
)
